...
lf_budget = (
    pl.scan_parquet("F:/Documents/Data/budget_df.parquet")
    .select("RINPERSOON")
...
lf_demographics = (
    pl.scan_parquet("F:/Documents/Data/df_demographics.parquet")
...
# machine learning
filename = "F:/Documents/Data/predicted_timeUse_ML_budgetPPs.parquet"
df_ML.write_parquet(filename)
print(f"Successfully wrote {filename}")

# baseline
filename = "F:/Documents/Data/predicted_timeUse_baseline_budgetPPs.parquet"
df_baseline.write_parquet(filename)
print(f"Successfully wrote {filename}")

# perCapita
filename = "F:/Documents/Data/predicted_timeUse_perCapita_budgetPPs.parquet"
